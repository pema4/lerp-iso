...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 975.0, 300.0, 125.0, 22.0 ],
					"text" : "scale -100. 100. -5. 5."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 975.0, 252.0, 267.0, 22.0 ],
...
,
					"text" : "param Time @min -100. @max 100. @default 0.",
					"varname" : "param[10]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 975.0, 207.0, 370.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
,
					"text" : "param \"Envelope Release\" @min 1.5 @max 60000. @default 2000.",
					"varname" : "param[9]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 975.0, 162.0, 338.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
,
					"text" : "param \"Envelope Attack\" @min 0. @max 20000. @default 10.",
					"varname" : "param[8]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 975.0, 117.0, 322.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_initial" : [ 0.0 ],
							"parameter_initial_enable" : 1,
...
,
					"text" : "param \"Mod Ratio Quantize\" @min 0. @max 8 @default 0.",
					"varname" : "param[7]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 975.0, 72.0, 274.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
,
					"text" : "param \"Mod Ratio\" @min 1. @max 8. @default 1.",
					"varname" : "param[6]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 975.0, 27.0, 306.0, 22.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
,
					"text" : "param \"Mod Amount\" @min 0. @max 100. @default 20.",
					"varname" : "param[5]"
				}
